/* =========================================================
   Dominations Calculator - airdefense.js (UNIFIED + SAFE)
   - 방공시설 HP + 파괴전술 필요 개수
   - 제조소(2슬롯/중복불가) + 연구 조건 HP 보너스
   - 제조소 "피격 감소"는 파괴전술(DMG)에만 적용
   - ✅ 방공시설 HP / 파괴전술 DMG: "모든 연구 완료(일괄 적용)" 추가
     * 제조소 드롭다운 4개(슬롯1/레벨/슬롯2/레벨) 자동 선택 ❌
   - ✅ 항목 초기화 시: 모든 연구 완료 체크도 해제 ✅
   - ✅ [AUTO] 연맹(HP+): 이집트/러시아 합계는 "추가 연구" 아래, 박스 최하단 표시 ✅
   ========================================================= */
