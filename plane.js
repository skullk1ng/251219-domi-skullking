...
(() => {
  ...
  const AIRCRAFT_DATA = {
    transport: [
      ...
      { age: "드론", name: "선봉 수송기 Mk.1", hp: 18543 },
      { age: "드론", name: "선봉 수송기 Mk.2", hp: 19007 },
      { age: "드론", name: "선봉 수송기 Mk.3", hp: 19482 },
      { age: "드론", name: "선봉 수송기 Mk.4", hp: 19969 },
      { age: "드론", name: "선봉 수송기 Mk.5", hp: 20468 },
      { age: "드론", name: "선봉 수송기 Mk.6", hp: 20980 },

      { age: "자동화", name: "캡틴 수송기 Mk.1", hp: 21520 },
      { age: "자동화", name: "캡틴 수송기 Mk.2", hp: 22070 },
      { age: "자동화", name: "캡틴 수송기 Mk.3", hp: 22750 },
      { age: "자동화", name: "캡틴 수송기 Mk.4", hp: 23228 },
      { age: "자동화", name: "캡틴 수송기 Mk.5", hp: 23903 },
      { age: "자동화", name: "캡틴 수송기 Mk.6", hp: 24582 },

      { age: "로봇공학", name: "소령 수송기 Mk1", hp: 25852 },
      { age: "로봇공학", name: "소령 수송기 Mk2", hp: 26311 },
      { age: "로봇공학", name: "소령 수송기 Mk3", hp: 26770 },
      { age: "로봇공학", name: "소령 수송기 Mk4", hp: 27229 },
      { age: "로봇공학", name: "소령 수송기 Mk5", hp: 27688 },
      { age: "로봇공학", name: "소령 수송기 Mk6", hp: 28147 },
      { age: "로봇공학", name: "소령 수송기 Mk7", hp: 28606 },
      { age: "로봇공학", name: "소령 수송기 Mk8", hp: 29065 },
      { age: "로봇공학", name: "소령 수송기 Mk9", hp: 29524 },
      { age: "로봇공학", name: "소령 수송기 Mk10", hp: 29983 },
    ],
    bomber: [
      ...
      { age: "드론", name: "선봉 폭격기 Mk.1", hp: 14000 },
      { age: "드론", name: "선봉 폭격기 Mk.2", hp: 14750 },
      { age: "드론", name: "선봉 폭격기 Mk.3", hp: 15488 },
      { age: "드론", name: "선봉 폭격기 Mk.4", hp: 16262 },
      { age: "드론", name: "선봉 폭격기 Mk.5", hp: 17075 },
      { age: "드론", name: "선봉 폭격기 Mk.6", hp: 17929 },
      ...
      { age: "로봇공학", name: "소령 폭격기 Mk1", hp: 25298 },
      { age: "로봇공학", name: "소령 폭격기 Mk2", hp: 25993 },
      { age: "로봇공학", name: "소령 폭격기 Mk3", hp: 26688 },
      { age: "로봇공학", name: "소령 폭격기 Mk4", hp: 27383 },
      { age: "로봇공학", name: "소령 폭격기 Mk5", hp: 28078 },
      { age: "로봇공학", name: "소령 폭격기 Mk6", hp: 28773 },
      { age: "로봇공학", name: "소령 폭격기 Mk7", hp: 29468 },
      { age: "로봇공학", name: "소령 폭격기 Mk8", hp: 30163 },
      { age: "로봇공학", name: "소령 폭격기 Mk9", hp: 30858 },
      { age: "로봇공학", name: "소령 폭격기 Mk10", hp: 31553 },
    ],
    scout: [
      ...
      { age: "드론", name: "선봉 정찰기 Mk.1", hp: 16917 },
      { age: "드론", name: "선봉 정찰기 Mk.2", hp: 17763 },
      { age: "드론", name: "선봉 정찰기 Mk.3", hp: 18651 },
      { age: "드론", name: "선봉 정찰기 Mk.4", hp: 19584 },
      { age: "드론", name: "선봉 정찰기 Mk.5", hp: 20563 },
      { age: "드론", name: "선봉 정찰기 Mk.6", hp: 21591 },
      ...
      { age: "로봇공학", name: "소령 정찰기 Mk1", hp: 29604 },
      { age: "로봇공학", name: "소령 정찰기 Mk2", hp: 30360 },
      { age: "로봇공학", name: "소령 정찰기 Mk3", hp: 31116 },
      { age: "로봇공학", name: "소령 정찰기 Mk4", hp: 31872 },
      { age: "로봇공학", name: "소령 정찰기 Mk5", hp: 32628 },
      { age: "로봇공학", name: "소령 정찰기 Mk6", hp: 33384 },
      { age: "로봇공학", name: "소령 정찰기 Mk7", hp: 34140 },
      { age: "로봇공학", name: "소령 정찰기 Mk8", hp: 34896 },
      { age: "로봇공학", name: "소령 정찰기 Mk9", hp: 35652 },
      { age: "로봇공학", name: "소령의 정찰기 Mk10", hp: 36408 },
    ],
  };
